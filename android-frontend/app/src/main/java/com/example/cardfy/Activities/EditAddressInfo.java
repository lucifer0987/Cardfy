...
public class EditAddressInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CurrCard.setAddress(address.getText().toString().trim());
                CurrCard.setCity(city.getText().toString().trim());
                CurrCard.setState(state.getText().toString().trim());
                CurrCard.setCountry(country.getText().toString().trim());
                updateDB();
            }
        });
        ...
        call.enqueue(new Callback<Card>() {
            ...
            public void onResponse(Call<Card> call, Response<Card> response) {
                if(response.code() == 200){
                    Toast.makeText(EditAddressInfo.this, "Data updated Successfully.", Toast.LENGTH_SHORT).show();
                    GetCard();
                }else{
                    Toast.makeText(EditAddressInfo.this, "Some Failure Occurred!! Please Try Again!!", Toast.LENGTH_LONG).show();
    ...
    private void changeActivity() {
        Intent i = new Intent(EditAddressInfo.this, EditProfileHome.class);
        startActivity(i);
    }
    ...
    private void InitValues() {
        ...
        address.setText(CurrCard.getAddress());
        city.setText(CurrCard.getCity());
        state.setText(CurrCard.getState());
        country.setText(CurrCard.getCountry());
    }
